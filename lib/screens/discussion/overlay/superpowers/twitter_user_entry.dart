...
class TwitterUserEntryWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if(isChecked) {
      checkMark = Icon(Icons.check_circle, color: Colors.grey, size: checkMarkSize);
    }
    else if(isSelected) {
      checkMark = Icon(Icons.check_circle, color: Colors.white, size: checkMarkSize);
    }
    return Container(
