...
class DiscussionInvite extends Equatable {
  ...
  List<Object> get props => [
    id, discussion, invitingParticipant, createdAt, updateAt, isDeleted, status
  ];

  factory DiscussionInvite.fromJson(Map<String, dynamic> json) => _$DiscussionInviteFromJson(json);
