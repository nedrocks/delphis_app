...
class GoneIncognitoDiscussionPopupContents extends StatelessWidget {
  ...
  String assholeMessage(String name) {
    return Intl.message('Don\'t be an asshole or it\'ll reflect badly on $name',
        args: [name]);
  }
          ...
          Container(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  AnonProfileImageWithNonAnon(
                      height: 100.0,
                      width: 100.0,
                      profileImageURL: this.moderator.profileImageURL),
                  Container(
